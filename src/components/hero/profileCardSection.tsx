...
const ProfileCardSection = () => {
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent<HTMLElement>) => {
      ...
      glowRef.current.style.background = `radial-gradient(320px circle at ${x}px ${y}px, var(--color-muted-foreground) 0%, transparent 100%)`;
    },
    []
  );
  ...
  return (
    <section
      ...
      className="max-w-3xl border-x border-border w-full flex relative overflow-hidden"
    >
      {/* Glow overlay */}
      <div
        ref={glowRef}
      ...
      {/* image part */}
      <div className="border-r border-border p-1 shrink-0">
        <Image
